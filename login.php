...
<tr>
<td>
<form id="formID" action="verify.php" method="post">
<table style="padding-left: 30px; padding-top: 50px;">
<tr>
<td></td><td style="color: rgb(196, 52, 121); font-family: arial; "><h2>
<?php
$s = (isset($_GET['s']));
if($s == '1'){
echo "Username and/or password did not match";
}else{
echo "Login";
}
?>
...
<tr>
	<td>User Name: </td><td><input type="text" class="validate[required]" name="username" id="username"></td>
</tr>
<tr>
	<td>Password: </td><td><input type="password" class="validate[required]" name="password" id="password"></td>
</tr>
<tr>
	<td></td><td><input type="submit" name="submit" id="login" value="Login"></td>
</tr>
<tr>
	<td></td><td><a href="register-user.php">Click here to register</a></td>
</tr>
</table>
</form>
</td>
