...
<form id="vrmainfrm" action="update-user-data.php" name="vrmainfrm" method="POST">
...
<tr>
	<td>Last Name: </td><td><input style="width: 200px;" type="text" value="<?php echo  $_SESSION['lastname']; ?>"  class="validate[required]" name="lastname" id="lastname"></td>
</tr>
<tr>
	<td>First Name: </td><td><input style="width: 200px;" type="text" value="<?php echo  $_SESSION['firstname']; ?>" class="validate[required]" name="firstname" id="firstname"></td>
</tr>
<tr>
	<td>Middle Name: </td><td><input style="width: 200px;" type="text" value="<?php echo  $_SESSION['middlename']; ?>" class="validate[required]" name="middlename" id="middlename"></td>
</tr>
<tr>
	<td>Address: </td><td><input style="width: 200px;" type="text" value="<?php echo  $_SESSION['address']; ?>" class="validate[required]" name="address" id="address"></td>
</tr>
<tr>
	<td>Contact Number: </td><td><input style="width: 200px;" value="<?php echo  $_SESSION['contactnumber']; ?>" class="validate[required]" name="contact" type="text" id="contact"></td>
</tr>
<tr>
	<td>Age: </td><td><input style="width: 200px;" type="text" value="<?php echo  $_SESSION['age']; ?>" class="validate[required]" name="age" id="age"></td>
</tr>

<tr>
	<td>Birthday: </td><td><input type="text" style="width: 200px;" value="<?php echo  $_SESSION['birthday']; ?>" class="validate[required] datepickervalue" name="birth" id="birth" class="datepickervalue"></td>
</tr>

<tr>
	<td>Student Number: </td><td><input type="text" style="width: 200px;" value="<?php echo  $_SESSION['studentnumber']; ?>" class="validate[required]" name="studentnumber" id="studentnumber"></td>
</tr>

<tr>
	<td>User Name: </td><td><input type="text" style="width: 200px;" value="<?php echo  $_SESSION['username']; ?>" class="validate[required]" name="username" id="username"></td>
</tr>

<tr>
	<td>Password: </td><td><input type="password" style="width: 200px;" value="<?php echo  $_SESSION['password']; ?>" class="validate[required]" name="password" id="password"></td>
</tr>

<tr><td>&nbsp</td><td>&nbsp</td></tr>
<tr>
	<td></td><td><input type="submit" name="submit" id="update" value="Update"></td>
</tr>
</table>
</td>
</tr>
